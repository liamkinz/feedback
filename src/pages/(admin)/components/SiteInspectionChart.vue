...
async function fetchData() {
  ...
  try {
    ...
    rawData.value = await fetchSiteInspectionChartData({ startDate: start, endDate: end })
  } catch (err) {
...
<template>
  ...
  >
    ...
    <div class="ic-header" :style="{ borderBottomColor: theme.headerBorder }">
      <div>
        <p class="ic-eyebrow" :style="{ color: theme.eyebrow }">Site Inspections</p>
        <p class="ic-title" :style="{ color: theme.title }">Daily Site Inspection Overview</p>
      </div>
