...
import { fetchFinalInspectionChartData } from '@/services/chartService'
...
async function fetchData() {
  ...
  try {
    ...
    rawData.value = await fetchFinalInspectionChartData({ startDate: start, endDate: end })
  } catch (err) {
...
<template>
  ...
  >
    ...
    <div class="ic-header" :style="{ borderBottomColor: theme.headerBorder }">
      <div>
        <p class="ic-eyebrow" :style="{ color: theme.eyebrow }">Final Inspections</p>
        <p class="ic-title" :style="{ color: theme.title }">Daily Final Inspection Overview</p>
      </div>
