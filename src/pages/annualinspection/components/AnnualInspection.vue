        ...
        <v-card class="modern-card csm-card" :class="{ 'dark-card': isDark }" elevation="0">
          <v-card-text style="padding: 32px">
            <p class="description-text">
              ...
              opisina sa gobyerno. Ang imong feedback sa bag-o lang nahuman na transaksyon sa
              opisina makatabang kini nga makahatag og mas maayong serbisyo. Ang personal na
              impormasyon na gipaambit itago na kompidensyal ug kanunay kang adunay kapilian kung
              dili nimu buot tubagon ang pangutana.
            </p>
          </v-card-text>
        </v-card>
      ...
      <div class="form-section">
        ...
        <v-card class="modern-card info-card" :class="{ 'dark-info-card': isDark }" elevation="0">
          <v-card-text style="padding: 24px">
            ...
            <p class="instructions-text">
              INSTRUCTIONS: Para sa SQD 0-8, palihug I-rate ang mosunod pinaagi sa pagpili I-click
              ang lingin (●) sa column nga tukma sa imung tubag.
            </p>
          </v-card-text>
        </v-card>
