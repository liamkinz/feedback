...
import { useAnnualInspection } from '../composables/useAnnualInspection'
import '@/pages/finalinspection/styles/FinalInspectionStyles.css'
  ...
  <div class="final-inspection-form">
    ...
    <v-card class="modern-card header-card" :class="{ 'dark-card': isDark }" elevation="0">
      <v-card-text style="padding: 32px">
        <h1 class="form-title">Annual Inspection Feedback Form</h1>
        <p class="form-subtitle">
          Salamat sa inyong pagbisita. Ang inyong feedback ay mahalaga sa amin upang mapabuti pa ang
          aming serbisyo.
        </p>
      </v-card-text>
    </v-card>
    ...
    <div class="form-section">
      ...
      <v-card class="modern-card csm-card" :class="{ 'dark-card': isDark }" elevation="0">
        <v-card-text style="padding: 32px">
          <p class="description-text">
            ...
            opisina sa gobyerno. Ang imong feedback sa bag-o lang nahuman na transaksyon sa opisina
            makatabang kini nga makahatag og mas maayong serbisyo. Ang personal na impormasyon na
            gipaambit itago na kompidensyal ug kanunay kang adunay kapilian kung dili nimu buot
      ...
      <v-card class="modern-card" :class="{ 'dark-card': isDark }" elevation="0">
        <v-card-text style="padding: 24px">
          <h3 class="section-title">Number of Annual Inspections</h3>
          <v-text-field
            v-model="respondentInfo.annualInspection"
            label="Number of Annual Inspections"
            type="number"
            hide-details
            class="modern-input"
            variant="outlined"
      ...
      <v-card class="modern-card" :class="{ 'dark-card': isDark }" elevation="0">
        <v-card-text style="padding: 24px">
          ...
          <p class="comments-description">
            ...
            kasinatian ug transaksyon sa among opisina. Ang inyong feedback makatabang sa pagpaayo
    ...
    <div class="form-section submit-section">
      <v-btn @click="handleSubmit" size="large" class="submit-button" color="primary" rounded="lg">
        Submit Feedback
      </v-btn>
    </div>
